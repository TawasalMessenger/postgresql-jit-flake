let
  ...
  in stdenv.mkDerivation rec {
    ...
    passthru = {
      ...
      # Remove packages in jit flake version by DZ
      #################################################################
      #pkgs = let
...
in self: {
  ...
  postgresql_10_jit = self.callPackage generic {
    version = "10.21";
  ...
  postgresql_11_jit = self.callPackage generic {
    version = "11.16";
  ...
  postgresql_12_jit = self.callPackage generic {
    version = "12.11";
    psqlSchema = "12";
  ...
  postgresql_13_jit = self.callPackage generic {
    version = "13.7";
    psqlSchema = "13";
  ...
  postgresql_14_jit = self.callPackage generic {
    version = "14.3";
    psqlSchema = "14";
